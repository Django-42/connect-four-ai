...
def human(spieler):
    while True:
        spalte = int(input('Ihr Zug (Spalte 0 bis 6): '))
...
def computer(spieler):
    ...
    for zug in zugliste():
        ...
        score = minimax(5, -999999, 999999, spieler, win)
...
def minimax(tiefe, alpha, beta, spieler, win):
    if win:
        return 99999 + tiefe if spieler else -99999 - tiefe  # "grausam": +- tiefe weglassen!
